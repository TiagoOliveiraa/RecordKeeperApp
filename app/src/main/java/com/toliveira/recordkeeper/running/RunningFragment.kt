...
import com.toliveira.recordkeeper.databinding.FragmentRunningBinding
...
class RunningFragment : Fragment() {
    ...
    private fun displayRecords() {
        val runningPreferences = activity?.getSharedPreferences("Running_Preferences",Context.MODE_PRIVATE)
